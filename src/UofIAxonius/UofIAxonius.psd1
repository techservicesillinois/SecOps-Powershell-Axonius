#
# Module manifest for module 'UofIAxonius'
#
...
GUID = '2bdfe790-9c29-4087-8524-639244a6c0ea'
...
Description = 'This Powershell module acts as a wrapper for the Axonius REST API'
...
FunctionsToExport = @(
    ...
    'Get-AxoniusAdapters',
    'Get-AxoniusFetchEvents',
    'Get-AxoniusFetchHistory'
)
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/techservicesillinois/SecOps-Powershell-Axonius/blob/master/LICENSE'
